  ...
  return (
    <div className="py-32 md:py-48 relative z-0 overflow-x-clip">
      <div className="absolute inset-0 [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_70%,transparent)]">
        ...
        <HeroOrbit size={800} rotation={-74}>
          <StarIcon className="size-24 text-emerald-300" />
        </HeroOrbit>
        <HeroOrbit size={450} rotation={-70}>
          <StarIcon className="size-12 text-emerald-300" />
        </HeroOrbit>
        <HeroOrbit size={590} rotation={120}>
          <StarIcon className="size-8 text-emerald-300" />
        </HeroOrbit>
        <HeroOrbit size={430} rotation={-28}>
          <SparkleIcon className="size-8 text-emerald-300/20" />
        </HeroOrbit>
        <HeroOrbit size={400} rotation={240}>
          <StarIcon className="size-5 text-emerald-300" />
        </HeroOrbit>
        <HeroOrbit size={440} rotation={110}>
      ...
      <div className="container">
        ...
        <div className="max-w-lg mx-auto">
          <h1 className="font-serif text-2xl md:text-4xl text-center mt-8 tracking-wide">
            Crafting Outstanding User Experiences
          </h1>
          <p className="mt-4 text-center text-white/60 md:text-base">
            Focused on delivering intuitive, high-performing web applications
            tailored to your needs. Let&apos;s make your vision a reality.
          </p>
        </div>
